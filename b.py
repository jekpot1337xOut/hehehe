...
\t https://www.facebook.com/fadiel.s.new
\t https://t.me/Nelssshere
"""
print (banner)
headers = {"User-Agent": "Mozilla/5.0 (Windows NT 6.1; rv:57.0) Gecko/20100101 Firefox/57.0"}
print ("""
1. Bing Dorker Random Domains
2. Get Weblist From IP
3. Get IP From Website
4. Add HTTP On All Weblist
5. URL List Cleaner
""")

nels = raw_input("root@youez:~# ")
